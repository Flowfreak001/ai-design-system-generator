...
export const SECTION_CATALOG: Partial<Record<SectionType, SectionCatalogEntry>> = {
  ...
  block: {
    ...
    variants: [
      ...
      V("location-card", "Location Card", "LocationCard", "blocks", ["local-service", "booking"], { supportsAssetSwap: true }),
      V("image-placeholder", "Image Placeholder", "ImagePlaceholder", "blocks", ["general"]),
      V("video-block", "Video Block", "VideoBlock", "blocks", ["general"]),
      ...
      // Phase 1 batch (components/blocks) — modern, shadcn/Magic-UI-inspired.
      V("bento-grid", "Bento Grid", "BentoGrid", "../blocks", ["saas", "platform", "agency"]),
      V("stat-band", "Stat Band", "StatBand", "../blocks", ["saas", "agency", "general"]),
      V("feature-split", "Feature Split", "FeatureSplit", "../blocks", ["saas", "agency", "software"], { supportsAssetSwap: true }),
      V("testimonial-spotlight", "Testimonial Spotlight", "TestimonialSpotlight", "../blocks", ["general", "agency", "local-service"]),
      V("pricing-highlight", "Pricing Highlight", "PricingHighlight", "../blocks", ["saas", "platform"]),
      V("comparison-row", "Comparison Row", "ComparisonRow", "../blocks", ["saas", "software"]),
      V("newsletter-inline", "Newsletter Inline", "NewsletterInline", "../blocks", ["blog", "ecommerce", "general"]),
