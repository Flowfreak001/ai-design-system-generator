...
export function themeCoreFiles(): GeneratedThemeFile[] {
  return [
    ...
    { path: "sections/main-404.liquid", contents: `<div class="page-width section" style="text-align:center"><h1>404</h1><p>{{ 'general.accessibility.skip_to_content' | t }}</p><a class="btn btn--primary" href="{{ routes.root_url }}">Continue shopping</a></div>\n{% schema %}\n{"name":"404"}\n{% endschema %}` },
  ];
}
